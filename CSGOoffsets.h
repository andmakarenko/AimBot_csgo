...
namespace offsets
{
	...
	constexpr ptrdiff_t dwForceAttack = 0x322DCFC;
	constexpr ptrdiff_t dwForceAttack2 = 0x322DD08;
	constexpr ptrdiff_t dwForceBackward = 0x322DD38;
	constexpr ptrdiff_t dwForceForward = 0x322DD2C;
	constexpr ptrdiff_t dwForceJump = 0x52BBC7C;
	constexpr ptrdiff_t dwForceLeft = 0x322DD44;
	constexpr ptrdiff_t dwForceRight = 0x322DD50;
	constexpr ptrdiff_t dwGameDir = 0x63AD80;
	constexpr ptrdiff_t dwGameRulesProxy = 0x532F4AC;
	constexpr ptrdiff_t dwGetAllClasses = 0xE0BFDC;
	constexpr ptrdiff_t dwGlobalVars = 0x59EE60;
	constexpr ptrdiff_t dwGlowObjectManager = 0x535A9C8;
	constexpr ptrdiff_t dwInput = 0x525D4C8;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x99BC84;
	constexpr ptrdiff_t dwLocalPlayer = 0xDEA964;
	constexpr ptrdiff_t dwMouseEnable = 0x5239128;
	constexpr ptrdiff_t dwMouseEnablePtr = 0x52390F8;
	constexpr ptrdiff_t dwPlayerResource = 0x322C0A0;
	constexpr ptrdiff_t dwRadarBase = 0x52369CC;
	...
	constexpr ptrdiff_t dwViewMatrix = 0x4DF0D24;
	constexpr ptrdiff_t dwWeaponTable = 0x525E5A4;
	...
	constexpr ptrdiff_t find_hud_element = 0x56DAFBD0;
	...
	constexpr ptrdiff_t m_pitchClassPtr = 0x5239020;
